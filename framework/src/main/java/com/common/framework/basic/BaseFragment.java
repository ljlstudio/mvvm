...
import com.common.framework.bus.Messenger;
...
//        initData();
    ...
    protected void registorUIChangeLiveDataCallBack() {
        ...
        viewModel.getUC().getStartActivityForFragment().observe(this, new Observer<Map<String, Object>>() {
            @Override
        ...
        viewModel.getUC().getResultFragment().observe(this, new Observer<Map<String, Object>>() {
            @Override
            public void onChanged(Map<String, Object> params) {
